...
//		paperEntity.setNoOFPages(paperDTO.getNoOFPages());
	...
	public boolean deleteNewsPaper(String newsPaperName) {
		...
		boolean result = this.paperDAO.deleteNewsPaperByName(newsPaperName);
	...
	@Override
	public boolean updateNewsPaper(PaperDTO paperDTO) {
		System.out.println("invoked updateNewsPaper..");
		boolean result = this.paperDAO.updateNewsPaperEntity(paperDTO);
